      ...
      <div class="p-10 px-20 space-y-8">
        <div>
          ...
          <form on:submit|preventDefault={saveAccountSettings} class="space-y-4">
            <div class="flex space-x-4">
              <div class="w-1/2">
                <Label for="firstName" class="block text-gray-700 dark:text-gray-100">First Name</Label>
                <Input id="firstName" type="firstName" bind:value={accountInfo.firstName} class="mt-2" />
              </div>
              <div class="w-1/2">
                <Label for="lastName" class="block text-gray-700 dark:text-gray-100">Last Name</Label>
                <Input id="lastName" type="lastName" bind:value={accountInfo.lastName} class="mt-2"  />
              </div>
            </div>
            <div>
              <Label for="username" class="block text-gray-700 dark:text-gray-100">Username</Label>
              <Input disabled id="username" type="username" bind:value={accountInfo.username} class="mt-2" />
            </div>
            <div>
              <Label for="email" class="block text-gray-700 dark:text-gray-100">Email Address</Label>
        ...
        <div class="pt-2">
          ...
          <form on:submit|preventDefault={changePassword} class="space-y-4">
            <div>
              <Label for="currentPassword" class="block text-gray-700 dark:text-gray-100">Current Password</Label>
              <Input id="currentPassword" type="currentPassword" bind:value={passwordInfo.currentPassword} class="mt-2" />
            </div>
            <div>
              <Label for="newPassword" class="block text-gray-700 dark:text-gray-100">New Password</Label>
              <Input id="newPassword" type="newPassword" bind:value={passwordInfo.newPassword} class="mt-2" />
            </div>
            <div>
              <Label for="confirmNewPassword" class="block text-gray-700 dark:text-gray-100">Confirm New Password</Label>
